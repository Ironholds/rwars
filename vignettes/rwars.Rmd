...
This is an R client library for the [http://swapi.co/](SWAPI service), a database of Star Wars metadata with an associated API. It can be used to retrieve data about everything from the films to individual vehicles, characters or planets.
...
```{r, eval=FALSE}
#Get an individual starship - an X-wing. Hopefully it won't Taim out and will actually bring the data Bak.
